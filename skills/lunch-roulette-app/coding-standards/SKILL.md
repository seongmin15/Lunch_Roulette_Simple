...
> This skill defines coding rules for the **lunch-roulette-app** service (Flutter / Dart).
...
// 4. Project imports
import 'package:lunch-roulette-app/features/auth/providers/auth_provider.dart';
import 'package:lunch-roulette-app/shared/widgets/loading_indicator.dart';
...
**Rules:**
- Use package imports (`package:lunch-roulette-app/...`) for cross-feature references.
